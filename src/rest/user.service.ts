...
import { StreamUserDao, UserEmailDao, UserTelecomDao, UserWeChatDao } from "./user-access.dao";
...
export class StreamUserService {
    ...
    async putAuthorization (owner: _Owner, timeExpire: number) {
        this.StreamLogRpc.simplePost(ENUM_STREAM_LOG.DEBUG, `user.ervice:putAuthorization`, Object.keys(owner.uuid32).toString())
